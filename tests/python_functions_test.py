...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
      cube_volume = volume_of_cube(6)
      self.assertEqual( 216, cube_volume )


  #Given a String, return the String reversed
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
      reversed_string = reverse_string("Test String")
      self.assertEqual("gnirtS tseT", reversed_string)
...
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
      f_to_c = farenheit_to_celsius(32)
      self.assertEqual(0, f_to_c)
